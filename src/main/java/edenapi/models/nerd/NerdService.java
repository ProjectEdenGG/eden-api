package edenapi.models.nerd;

import dev.morphia.query.Query;
import edenapi.exceptions.EdenException;
import edenapi.models.hours.HoursService;
import edenapi.mongodb.MongoService;
import edenapi.mongodb.annotations.PlayerClass;
import edenapi.utils.Utils;
...
public class NerdService extends MongoService<Nerd> {
	...
	public Nerd getFromName(String name) {
		return database.createQuery(Nerd.class).filter("name", sanitize(name)).find().tryNext();
	}
