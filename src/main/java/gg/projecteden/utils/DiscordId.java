...
public class DiscordId {
	...
	public enum TextChannel {
		...
		BIRTHDAYS("968229444777046056"),
		BOTS("223897739082203137"),

		SURVIVAL("709504495373123594"),
		MINIGAMES("133970350957395968"),
		ONEBLOCK("831645582405533726"),
		CREATIVE("831645551073165332"),
	...
	public enum VoiceChannel {
		...
		public net.dv8tion.jda.api.entities.VoiceChannel get(JDA jda) {
			return Guild.PROJECT_EDEN.get(jda).getVoiceChannelById(id);
		}
	...
	public enum User {
		...
		public net.dv8tion.jda.api.entities.Member getMember(JDA jda) {
			return Guild.PROJECT_EDEN.get(jda).retrieveMemberById(id).complete();
		}
	}
	...
	public enum Guild {
		...
		public net.dv8tion.jda.api.entities.Guild get(JDA jda) {
			return Objects.requireNonNull(jda.getGuildById(id), "Guild not retrieve " + camelCase(this) + " guild");
		}
	}
	...
	public enum Role {
		...
		STAFF_BIRTHDAY("968228226109415474"),
		BIRTHDAY("968225150610862110"),
		;

		private final String id;

		public net.dv8tion.jda.api.entities.Role get(JDA jda) {
			return Guild.PROJECT_EDEN.get(jda).getRoleById(id);
		}
